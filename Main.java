...
public class Main
{
        ...
        throws InterruptedException
    {
        ...
        /*
         ************************************************************
         * This is where we start to build our own application.
         * To create fake users, fake traffic
         ************************************************************
         */
        ...
        // HostInfo constructor public HostInfo ( String XMPPdomain, String XMPPhost, int port, String MUCdomain, String roomName)
        /*
	    ...
	    String audioRtpdumpFile = "/Users/Yao/Documents/workspace/jitsi-hammer/resources/rtp_opus.rtpdump";
	    MediaDevice audioMediaDevice
        = RtpdumpMediaDevice.createRtpdumpAudioMediaDevice(
                audioRtpdumpFile,
                opusFormat);
	    // set video packet
        String videoRtpdumpFile = "/Users/Yao/Documents/workspace/jitsi-hammer/resources/rtp_vp8.rtpdump";
	    ...
	    int statsPolling = 5;
	    // how long does the fake conference run in seconds. if 0 or negative, never stops.
	    int runLength = 5;
